...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-codemirror/node_modules/codemirror/mode/cmake/cmake.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-codemirror/node_modules/codemirror/mode/cmake/cmake.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-codemirror/node_modules/codemirror/mode/cmake/</a> &#187; cmake.js</div>
</div>
<div class="body">
...
"use strict";
&nbsp;
CodeMirror.defineMode("cmake", <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var variable_regex = /({)?[a-zA-Z0-9_]+(})?/;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (stream.match(/(\s+)?\w+\(/) || stream.match(/(\s+)?\w+\ \(/)) {</span>
<span class="cstat-no" title="statement not covered" >      stream.backUp(1);</span>
