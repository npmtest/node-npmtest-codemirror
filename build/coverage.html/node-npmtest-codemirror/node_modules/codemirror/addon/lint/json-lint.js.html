...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-codemirror/node_modules/codemirror/addon/lint/json-lint.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-codemirror/node_modules/codemirror/addon/lint/json-lint.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-codemirror/node_modules/codemirror/addon/lint/</a> &#187; json-lint.js</div>
</div>
<div class="body">
...
"use strict";
&nbsp;
CodeMirror.registerHelper("lint", "json", <span class="fstat-no" title="function not covered" >function(text) {</span>
<span class="cstat-no" title="statement not covered" >  var found = [];</span>
<span class="cstat-no" title="statement not covered" >  jsonlint.parseError = <span class="fstat-no" title="function not covered" >function(str, hash) {</span></span>
<span class="cstat-no" title="statement not covered" >    var loc = hash.loc;</span>
<span class="cstat-no" title="statement not covered" >    found.push({from: CodeMirror.Pos(loc.first_line - 1, loc.first_column),</span>
                to: CodeMirror.Pos(loc.last_line - 1, loc.last_column),
                message: str});
  };
<span class="cstat-no" title="statement not covered" >  try { <span class="cstat-no" title="statement not covered" >jsonlint.parse(text); </span>}</span>
  catch(e) {}
