...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-codemirror/node_modules/codemirror/addon/lint/yaml-lint.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-codemirror/node_modules/codemirror/addon/lint/yaml-lint.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-codemirror/node_modules/codemirror/addon/lint/</a> &#187; yaml-lint.js</div>
</div>
<div class="body">
...
&nbsp;
CodeMirror.registerHelper("lint", "yaml", <span class="fstat-no" title="function not covered" >function(text) {</span>
<span class="cstat-no" title="statement not covered" >  var found = [];</span>
<span class="cstat-no" title="statement not covered" >  try { <span class="cstat-no" title="statement not covered" >jsyaml.load(text); </span>}</span>
  catch(e) {
<span class="cstat-no" title="statement not covered" >      var loc = e.mark,</span>
          ...
          to = from;
<span class="cstat-no" title="statement not covered" >      found.push({ from: from, to: to, message: e.message });</span>
  }
